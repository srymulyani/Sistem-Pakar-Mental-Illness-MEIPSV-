...
<html><head>
    ...
    <base href="http://localhost/MEIPSV/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-contao" aria-hidden="true"></i> MEIPSV</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>  MEIPSV</b></span>
        </a>
        <!-- Header Navbar -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">©2021 - Developed with <i class="fa fa-heart pulse"></i> by <a href="http://www.mycoding.net" target="_blank">MEIPSV</a></div></strong>
      </footer>
